...
<aside id="sidebar"
    class="fixed top-0 left-0 z-99999 mt-0 flex h-screen flex-col border-r border-gray-200 bg-white px-5 text-gray-900 transition-all duration-300 ease-in-out"
    x-data="{
        openSubmenus: {},
        init() {
    ...
    <div class="pt-8 pb-7 flex"
        ...
        'xl:justify-center' :
        'justify-start'">
        <a href="{{ request()->segment(1) === 'admin' ? '/admin/dashboard' : '/student/dashboard' }}">
            <img x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                src="/images/logo/new-life-logistix-logo.jpg" alt="New Life Logistix" width="220" height="58" class="h-auto w-[220px] rounded-sm" />
            <img x-show="!$store.sidebar.isExpanded && !$store.sidebar.isHovered && !$store.sidebar.isMobileOpen"
