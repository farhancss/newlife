                    ...
                    <div class="mx-auto w-full max-w-md">
                        ...
                        <form action="{{ route('password.update') }}" method="POST">
                            ...
                            >
                                <button
                                    type="submit"
                                    class="flex h-12 w-full items-center justify-center rounded-lg bg-brand-500 px-4 text-sm font-semibold text-white transition hover:bg-brand-600 focus:outline-hidden focus:ring-3 focus:ring-brand-500/30 disabled:cursor-not-allowed disabled:opacity-50"
