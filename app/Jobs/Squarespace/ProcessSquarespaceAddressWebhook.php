...
class ProcessSquarespaceAddressWebhook implements ShouldQueue, ShouldBeUnique
{
    use Queueable;
    ...
    {
        return 'squarespace-address-' . $this->webhookEventId;
    }
    ...
    public function handle(AccountProvisioningService $provisioning): void
    {
        ...
        try {
            $provisioning->syncFromAddressNotification($event->payload);
            $event->update([
